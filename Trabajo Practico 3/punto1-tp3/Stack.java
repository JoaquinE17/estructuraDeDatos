...
public class Stack<ELEMENT> {
 ...
 // Muestra el objeto situado en la parte superior de esta pila sin retirarlo de ella.
 public ELEMENT peek() {
     if (this.empty()) {
 ...
 // Elimina el objeto situado en la parte superior de esta pila y devuelve ese objeto como valor de esta función.
 public ELEMENT pop() {
     if (this.empty()) {
         throw new RuntimeException("La pila está vacía...");
     }
...
*/ 
 ...
 // Devuelve la posición en donde se encuentra un objeto en esta pila.
...
// Retorna el número de componentes que contiene el vector.
 public int size() {
     return this.count;
 }
