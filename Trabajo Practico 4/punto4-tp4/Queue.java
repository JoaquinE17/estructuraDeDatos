...
public class Queue<ELEMENT> {
    ...
    // inmediatamente sin violar las restricciones de capacidad. Retorna true si tiene éxito
    // y lanza una IllegalStateException si no hay espacio disponible actualmente.
    ...
    //
    // Recupera, pero no elimina, el primer elemento de esta cola. Este método difiere
    // de peek solo en que lanza una excepción si la cola está vacía.
    ...
    //
    // Inserta el elemento especificado en esta cola si es posible hacerlo
    // inmediatamente sin violar las restricciones de capacidad. Al utilizar una
    // cola con capacidad limitada, este método es generalmente preferible a add(E),
    // que puede fallar al insertar un elemento únicamente lanzando una excepción.
    ...
    // Recupera, pero no elimina, el primer elemento de esta cola, o retorna null si
    // la cola está vacía.
    public ELEMENT peek() {
        if (this.size() <= 0) {
            return null;
    ...
    //
    // Recupera y elimina el primer elemento de esta cola, o retorna null si
    // la cola está vacía.
    public ELEMENT pool() {
        if (this.size() <= 0) {
            return null;
    ...
    // Operacion DeQueue en la teoría de Estructura de Datos
    //
    // Recupera y elimina el primer elemento de esta cola. Este método difiere de poll()
    // solo en que lanza una excepción si la cola está vacía.
